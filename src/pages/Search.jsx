  ...
  return (
    <div>
      ...
      <div className="flex justify-center mt-[32px] space-x-6">
        <button className="space-x-8 px-4 py-2 rounded-md bg-[#f5f1f1] border border-white hover:border-slate-300" type={"submit"}>Google Search</button>
        <button className="space-x-8 px-4 py-2 rounded-md bg-[#f5f1f1] border border-white hover:border-slate-300">I'm feeling lucky</button>
      </div>
    </div>
  );
};
